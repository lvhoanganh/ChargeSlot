...
import { t as require_jsx_runtime } from "./jsx-runtime-ZYVWLxs-.js";
...
var dist_exports$24 = /* @__PURE__ */ __export({
	Root: () => Slot$4,
	Slot: () => Slot$4,
...
var Primitive = [
	...
	const Slot$5 = createSlot(`Primitive.${node}`);
...
var dist_exports$32 = /* @__PURE__ */ __export({
	Root: () => Root$16,
...
function createContext2(rootComponentName, defaultContext) {
	...
	Provider$3.displayName = rootComponentName + "Provider";
...
function createCollection(name) {
	...
	const [createCollectionContext, createCollectionScope$9] = createContextScope(PROVIDER_NAME$2);
	...
	function useCollection$9(scope) {
...
function createCollection2(name) {
	const PROVIDER_NAME$2 = name + "CollectionProvider";
	const [createCollectionContext, createCollectionScope$9] = createContextScope(PROVIDER_NAME$2);
	const [CollectionContextProvider, useCollectionContext] = createCollectionContext(PROVIDER_NAME$2, {
	...
	const CollectionInit = (props) => {
		const state = useInitCollection$1();
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CollectionProviderImpl, {
			...props,
			state
		});
	};
	CollectionInit.displayName = PROVIDER_NAME$2 + "Init";
	...
	CollectionProviderImpl.displayName = PROVIDER_NAME$2 + "Impl";
	const COLLECTION_SLOT_NAME = name + "CollectionSlot";
	const CollectionSlotImpl = createSlot(COLLECTION_SLOT_NAME);
	const CollectionSlot = import_react.forwardRef((props, forwardedRef) => {
		const { scope, children } = props;
	...
	return [{
		...
		createCollectionScope: createCollectionScope$9,
		useCollection: useCollection$9,
		useInitCollection: useInitCollection$1
	}];
}
...
var dist_exports$6 = /* @__PURE__ */ __export({
...
var dist_exports$9 = /* @__PURE__ */ __export({
...
var dist_exports$1 = /* @__PURE__ */ __export({
	Accordion: () => Accordion,
...
var dist_exports$17 = /* @__PURE__ */ __export({
	Portal: () => Portal,
	Root: () => Root$13
});
...
Portal.displayName = PORTAL_NAME$10;
var Root$13 = Portal;
...
var dist_exports$8 = /* @__PURE__ */ __export({
	Close: () => Close$2,
	Content: () => Content$3,
...
var dist_exports$2 = /* @__PURE__ */ __export({
	Action: () => Action$1,
...
var dist_exports$3 = /* @__PURE__ */ __export({
...
var require_use_sync_external_store_shim_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js": ((exports) => {
	(function() {
		...
		var React$3 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState$1 = React$3.useState, useEffect = React$3.useEffect, useLayoutEffect$1 = React$3.useLayoutEffect, useDebugValue = React$3.useDebugValue, didWarnOld18Alpha = !1, didWarnUncachedGetSnapshot = !1, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var dist_exports$5 = /* @__PURE__ */ __export({
	Checkbox: () => Checkbox,
...
function CheckboxProvider(props) {
	...
	const isFormControl$1 = control ? !!form || !!control.closest("form") : true;
	const context = {
		checked,
		disabled,
		setChecked,
...
var CheckboxTrigger = import_react.forwardRef(({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
	const { control, value, disabled, checked, required, setControl, setChecked, hasConsumerStoppedPropagationRef, isFormControl: isFormControl$1, bubbleInput } = useCheckboxContext(TRIGGER_NAME$9, __scopeCheckbox);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.button, {
		...
		onClick: composeEventHandlers(onClick, (event) => {
			...
			if (bubbleInput && isFormControl$1) {
...
var Checkbox = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckboxProvider, {
		...
		form,
		value,
		internal_do_not_use_render: ({ isFormControl: isFormControl$1 }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckboxTrigger, {
			...checkboxProps,
			ref: forwardedRef,
			__scopeCheckbox
		}), isFormControl$1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckboxBubbleInput, { __scopeCheckbox })] })
	});
});
...
var dist_exports$7 = /* @__PURE__ */ __export({
	Arrow: () => Arrow2$6,
...
var dist_exports$10 = /* @__PURE__ */ __export({
	Arrow: () => Arrow2$5,
...
var dist_exports$13 = /* @__PURE__ */ __export({
	Label: () => Label$1,
	Root: () => Root$7
});
var NAME$2 = "Label";
...
var dist_exports$11 = /* @__PURE__ */ __export({
	Control: () => Control,
	Field: () => Field,
	Form: () => Form,
...
var dist_exports$12 = /* @__PURE__ */ __export({
	Arrow: () => Arrow2$4,
	Content: () => Content2$4,
	HoverCard: () => HoverCard,
...
var dist_exports$15 = /* @__PURE__ */ __export({
	Content: () => Content$1,
...
var NavigationMenuIndicator = import_react.forwardRef((props, forwardedRef) => {
	...
	return context.indicatorTrack ? import_react_dom$4.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
...
var NavigationMenuContentImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const motionAttribute = import_react.useMemo(() => {
		...
		const index$1 = values.indexOf(context.value);
		...
		const attribute = (() => {
			if (index$1 !== prevIndex) {
				if (isSelected && prevIndex !== -1) return index$1 > prevIndex ? "from-end" : "from-start";
				if (wasSelected && index$1 !== -1) return index$1 > prevIndex ? "to-start" : "to-end";
			}
			return null;
		})();
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DismissableLayer, {
			...
			onKeyDown: composeEventHandlers(props.onKeyDown, (event) => {
				...
				if (event.key === "Tab" && !isMetaKey) {
					...
					const focusedElement = document.activeElement;
					const index$1 = candidates.findIndex((candidate) => candidate === focusedElement);
					if (focusFirst$1(event.shiftKey ? candidates.slice(0, index$1).reverse() : candidates.slice(index$1 + 1, candidates.length))) event.preventDefault();
...
var NavigationMenuViewportImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const [size$3, setSize] = import_react.useState(null);
	const [content, setContent] = import_react.useState(null);
	const viewportWidth = size$3 ? size$3?.width + "px" : void 0;
	const viewportHeight = size$3 ? size$3?.height + "px" : void 0;
	const open = Boolean(context.value);
...
var dist_exports$33 = /* @__PURE__ */ __export({
...
var OneTimePasswordField = import_react.forwardRef(function OneTimePasswordFieldImpl({ __scopeOneTimePasswordField, defaultValue, value: valueProp, onValueChange, autoSubmit = false, children, onPaste, onAutoSubmit, disabled = false, readOnly = false, autoComplete = "one-time-code", autoFocus = false, form, name, placeholder, type = "text", orientation = "horizontal", dir, validationType = "numeric", sanitizeValue: sanitizeValueProp, ...domProps }, forwardedRef) {
	...
	const dispatch = useEffectEvent((action) => {
		switch (action.type) {
			case "SET_CHAR": {
				const { index: index$1, char } = action;
				const currentTarget = collection.at(index$1)?.element;
				...
				if (value.length >= collection.size) {
					...
					newValue2[index$1] = char;
					(0, import_react_dom$3.flushSync)(() => setValue(newValue2));
					focusInput(currentTarget && collection.from(currentTarget, 1)?.element);
					return;
				}
				const newValue = [...value];
				newValue[index$1] = char;
				const lastElement = collection.at(-1)?.element;
				(0, import_react_dom$3.flushSync)(() => setValue(newValue));
				if (currentTarget !== lastElement) focusInput(currentTarget && collection.from(currentTarget, 1)?.element);
				else currentTarget?.select();
				return;
			}
			case "CLEAR_CHAR": {
				const { index: index$1, reason } = action;
				if (!value[index$1]) return;
				const newValue = value.filter((_, i) => i !== index$1);
				const currentTarget = collection.at(index$1)?.element;
			...
			case "CLEAR":
				...
				if (action.reason === "Backspace" || action.reason === "Delete") {
					(0, import_react_dom$3.flushSync)(() => setValue([]));
			...
			case "PASTE": {
				...
				if (!value2) return;
				(0, import_react_dom$3.flushSync)(() => setValue(value2));
...
var OneTimePasswordFieldInput = import_react.forwardRef(function OneTimePasswordFieldInput2({ __scopeOneTimePasswordField, onInvalidChange, index: indexProp, ...props }, forwardedRef) {
	...
	const [element, setElement] = import_react.useState(null);
	const index$1 = indexProp ?? (element ? collection.indexOf(element) : -1);
	const canSetPlaceholder = indexProp != null || isHydrated;
	let placeholder;
	if (canSetPlaceholder && context.placeholder && context.value.length === 0) placeholder = context.placeholder[index$1];
	const composedInputRef = useComposedRefs(forwardedRef, inputRef, setElement);
	const char = context.value[index$1] ?? "";
	...
	const isFocusable = index$1 <= lastSelectableIndex;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$3.ItemSlot, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item$2, {
			...
			active: index$1 === lastSelectableIndex,
			children: ({ hasTabStop, isCurrentTabStop }) => {
				const supportsAutoComplete = hasTabStop ? isCurrentTabStop : index$1 === 0;
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$17.input, {
					ref: composedInputRef,
					type: context.type,
					disabled,
					"aria-label": `Character ${index$1 + 1} of ${collection.size}`,
					...
					onPointerDown: composeEventHandlers(props.onPointerDown, (event) => {
						event.preventDefault();
						const indexToFocus = Math.min(index$1, lastSelectableIndex);
...
var dist_exports$34 = /* @__PURE__ */ __export({
...
function requestIdleCallback(window2, callback, options$1) {
	if (window2.requestIdleCallback) {
		const id2 = window2.requestIdleCallback(callback, options$1);
		return () => {
...
var dist_exports$16 = /* @__PURE__ */ __export({
	Anchor: () => Anchor2,
	Arrow: () => Arrow2$2,
	Close: () => Close$1,
	Content: () => Content2$2,
...
var dist_exports$18 = /* @__PURE__ */ __export({
...
var dist_exports$19 = /* @__PURE__ */ __export({
	Indicator: () => Indicator,
	Item: () => Item2$1,
...
var Radio = import_react.forwardRef((props, forwardedRef) => {
	...
	const hasConsumerStoppedPropagationRef = import_react.useRef(false);
	const isFormControl$1 = button ? form || !!button.closest("form") : true;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(RadioProvider, {
		...
		}), isFormControl$1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioBubbleInput, {
			control: button,
...
var dist_exports$20 = /* @__PURE__ */ __export({
	Corner: () => Corner,
	Root: () => Root$4,
...
var dist_exports$21 = /* @__PURE__ */ __export({
	Arrow: () => Arrow2$1,
	Content: () => Content2$1,
	Group: () => Group,
	Icon: () => Icon,
...
var Select = (props) => {
	...
	const isFormControl$1 = trigger ? form || !!trigger.closest("form") : true;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root2$10, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectProvider, {
			...
			}), isFormControl$1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectBubbleInput, {
				"aria-hidden": true,
				required,
				tabIndex: -1,
				name,
...
var SelectContentImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	useFocusGuards();
	const focusFirst$5 = import_react.useCallback((candidates) => {
	...
	const focusSelectedItem = import_react.useCallback(() => focusFirst$5([selectedItem, content]), [
		focusFirst$5,
		selectedItem,
		content
	]);
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectPosition, {
						...
						onKeyDown: composeEventHandlers(contentProps.onKeyDown, (event) => {
							...
							if ([
								...
								setTimeout(() => focusFirst$5(candidateNodes));
								event.preventDefault();
							}
						})
					})
...
var dist_exports$22 = /* @__PURE__ */ __export({
	Root: () => Root$3,
...
var dist_exports$23 = /* @__PURE__ */ __export({
	Range: () => Range,
	Root: () => Root$2,
	Slider: () => Slider,
...
var SliderThumbImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const [thumb, setThumb] = import_react.useState(null);
	const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
	const isFormControl$1 = thumb ? context.form || !!thumb.closest("form") : true;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		...
		}), isFormControl$1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderBubbleInput, {
...
var dist_exports$25 = /* @__PURE__ */ __export({
	Root: () => Root$1,
	Switch: () => Switch,
...
var Switch = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SwitchProvider, {
		...
		}), isFormControl$1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SwitchBubbleInput, {
			control: button,
			bubbles: !hasConsumerStoppedPropagationRef.current,
			name,
			value,
...
var dist_exports$26 = /* @__PURE__ */ __export({
	Content: () => Content,
	List: () => List,
	Root: () => Root2$2,
	Tabs: () => Tabs,
...
var dist_exports$27 = /* @__PURE__ */ __export({
	Action: () => Action,
	Close: () => Close,
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$14, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.li, {
					...
					onPointerMove: composeEventHandlers(props.onPointerMove, (event) => {
						...
						const clampedX = isHorizontalSwipe ? clamp$2(0, x) : 0;
...
var dist_exports$28 = /* @__PURE__ */ __export({
	Root: () => Root,
	Toggle: () => Toggle
});
var NAME = "Toggle";
...
var dist_exports$29 = /* @__PURE__ */ __export({
	Item: () => Item2,
	Root: () => Root2,
...
var dist_exports$30 = /* @__PURE__ */ __export({
	Button: () => Button,
	Link: () => Link,
	Root: () => Root4,
	Separator: () => Separator,
...
var dist_exports$31 = /* @__PURE__ */ __export({
	Arrow: () => Arrow2,
	Content: () => Content2,
	Portal: () => Portal$1,
	Provider: () => Provider,
