        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChargingStations_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChargingSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChargingSlots_ChargingStations_ChargingStationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChargingSlotId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_ChargingSlots_ChargingSlotId",
                        column: x => x.ChargingSlotId,
                        principalTable: "ChargingSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ChargingSlotId",
                table: "Bookings",
                column: "ChargingSlotId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChargingSlots_ChargingStationId",
                table: "ChargingSlots",
